...
- **甜甜圈图**：内外环钻取，按业务语义着色（餐饮黄、饮品浅蓝、医疗红、住房绿…）<br>周→每日、月→每日、年→每月，点击内环展开子周期分类明细
...
| **v3.2** | **甜甜圈图钻取** — 饼图改为内外环甜甜圈图：周→每天、月→每天、年→每月。点击内环展开对应子周期的分类明细，点击中心返回总览 |
