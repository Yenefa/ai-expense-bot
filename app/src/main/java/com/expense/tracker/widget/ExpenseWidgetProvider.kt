...
class ExpenseWidgetProvider : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        val (amountText, budgetText, progress) = readSnapshot(context)
    ...
    private fun readSnapshot(context: Context): Triple<String, String, Int> {
        return runBlocking {
            ...
            Triple(amountText, budgetText, progress)
        }
    }
    ...
    companion object {
        fun requestRefresh(context: Context) {
            ...
            if (ids.isNotEmpty()) {
                ExpenseWidgetProvider().onUpdate(context, manager, ids)
            }
        }
    }
}
